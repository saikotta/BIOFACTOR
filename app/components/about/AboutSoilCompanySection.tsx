    ...
    >
      <div key={animationCycle} className="w-full">
        ...
        <div className="w-full max-w-[1500px] mx-auto px-6 sm:px-10 lg:px-16 text-center mb-8 sm:mb-10 lg:mb-12">
          <span
            className={`block text-[13px] font-semibold tracking-[0.06em] uppercase text-[#155B2A] mb-2 sm:mb-2.5 ${
          ...
          <h2
            className={`text-[clamp(34px,3vw,48px)] font-bold text-[#155B2A] tracking-[-0.025em] leading-[1.1] max-w-xl mx-auto font-sans ${
              prefersReducedMotion
                ? "opacity-100"
                : isAnimated
        ...
        <div className="w-full mb-12 sm:mb-16 lg:mb-20">
          <div
            className={`relative w-full h-[280px] sm:h-[330px] md:h-[370px] lg:h-[400px] overflow-hidden ${
              prefersReducedMotion
                ? ""
                : isAnimated
          ...
          >
            <img
              ...
              className={`w-full h-full object-cover object-[32%_50%] block border-none outline-none shadow-none rounded-none ${
                prefersReducedMotion
      ...
      <div
        ...
        className="w-full max-w-[1500px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-20"
      >
        <div
          key={frame4Cycle}
          className="w-full flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-14 xl:gap-18"
        >
          {/* LEFT COLUMN: COMPANY DESCRIPTION & ONEHEALTH STATEMENT */}
          <div className="w-full lg:w-[48%] xl:w-[46%] flex flex-col items-start">
            
            {/* STAGE 1: Company Description Paragraph */}
            <p
              className={`text-[16px] sm:text-[17px] lg:text-[18px] leading-[1.65] text-[#17251C] font-normal max-w-[600px] mb-8 sm:mb-10 ${
                prefersReducedMotion
                  ? "opacity-100"
                  : isFrame4Animated
            ...
            <div
              className={`w-full max-w-[540px] text-[clamp(20px,1.6vw,25px)] leading-[1.4] tracking-[-0.015em] text-[#17251C] ${
                prefersReducedMotion
                  ? "opacity-100"
                  : isFrame4Animated
          ...
          <div className="w-full lg:w-[52%] xl:w-[54%]">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 sm:gap-4 lg:gap-5">
              
              {/* STAGE 3: Card 1 - PRODUCT RANGE (100+) */}
              <div
                className={`relative overflow-hidden sm:col-span-2 lg:col-span-6 lg:col-start-7 bg-[#176B3A] text-white p-5 sm:p-6 rounded-[14px] flex flex-col justify-between min-h-[145px] sm:min-h-[155px] ${
                  prefersReducedMotion
                    ? "opacity-100"
                    : isFrame4Animated
              ...
              >
                <div
                  className={`relative z-10 flex flex-col justify-between h-full ${
                    !prefersReducedMotion && isFrame4Animated ? "animate-s4-card-inner-1 opacity-65 fill-mode-forwards" : ""
                  }`}
                >
                  <span className="text-[11px] font-bold tracking-[0.08em] uppercase text-white/80 block mb-4">
                    PRODUCT RANGE
                  </span>
                  <div>
                    <div className="text-[32px] sm:text-[36px] font-bold tracking-[-0.02em] leading-none mb-1">
                      100+
                    </div>
                ...
                <img
                  ...
                  alt=""
                  className="absolute bottom-3 right-3.5 w-[46px] h-[46px] sm:w-[54px] sm:h-[54px] pointer-events-none select-none z-0 object-contain"
                />
              </div>

              {/* STAGE 3: Card 2 - VERTICALS */}
              <div
                className={`relative overflow-hidden sm:col-span-1 lg:col-span-7 bg-[#2F7A44] text-white p-5 sm:p-6 rounded-[14px] flex flex-col justify-between min-h-[145px] ${
                  prefersReducedMotion
                    ? "opacity-100"
                    : isFrame4Animated
              ...
              >
                <div
                  className={`relative z-10 flex flex-col justify-between h-full ${
                    !prefersReducedMotion && isFrame4Animated ? "animate-s4-card-inner-2 opacity-65 fill-mode-forwards" : ""
                  }`}
                >
                  <span className="text-[11px] font-bold tracking-[0.08em] uppercase text-white/80 block mb-4">
                    VERTICALS
                  </span>
                  <div className="flex flex-col gap-1 text-[13px] font-medium text-white/95">
                ...
                <img
                  ...
                  alt=""
                  className="absolute bottom-3 right-3.5 w-[42px] h-[42px] sm:w-[48px] sm:h-[48px] pointer-events-none select-none z-0 object-contain"
                />
              </div>

              {/* STAGE 3: Card 3 - IP (6 patents) */}
              <div
                className={`relative overflow-hidden sm:col-span-1 lg:col-span-5 bg-[#C8E4A9] text-[#17251C] p-5 sm:p-6 rounded-[14px] flex flex-col justify-between min-h-[145px] ${
                  prefersReducedMotion
                    ? "opacity-100"
                    : isFrame4Animated
              ...
              >
                <div
                  className={`relative z-10 flex flex-col justify-between h-full ${
                    !prefersReducedMotion && isFrame4Animated ? "animate-s4-card-inner-3 opacity-65 fill-mode-forwards" : ""
                  }`}
                >
                  <span className="text-[11px] font-bold tracking-[0.08em] uppercase text-[#155B2A] block mb-4">
                    IP
                  </span>
                  <div>
                    ...
                    <div className="text-[12px] sm:text-[13px] font-medium text-[#17251C]/80">
              ...
              <div
                className={`relative overflow-hidden sm:col-span-1 lg:col-span-5 bg-[#C8E4A9] text-[#17251C] p-5 sm:p-6 rounded-[14px] flex flex-col justify-between min-h-[140px] ${
                  prefersReducedMotion
                    ? "opacity-100"
                    : isFrame4Animated
              ...
              >
                <div
                  className={`relative z-10 flex flex-col justify-between h-full ${
                    !prefersReducedMotion && isFrame4Animated ? "animate-s4-card-inner-4 opacity-65 fill-mode-forwards" : ""
                  }`}
                >
                  <span className="text-[11px] font-bold tracking-[0.08em] uppercase text-[#155B2A] block mb-4">
                    DOMESTIC REACH
                  ...
                  <div>
                    ...
                    <div className="text-[12px] sm:text-[13px] font-medium text-[#17251C]/85">
                      Indian states, 3,000+ dealers
                    </div>
                  </div>
                </div>
                {/* Reconstructed Figma Location Pin Icon */}
                <div className="absolute bottom-2.5 right-3.5 w-[44px] h-[51px] sm:w-[50px] sm:h-[58px] pointer-events-none select-none z-0">
                  <img
              ...
              <div
                className={`relative overflow-hidden sm:col-span-1 lg:col-span-3 bg-[#176B3A] text-white p-5 sm:p-6 rounded-[14px] flex flex-col justify-between min-h-[140px] ${
                  prefersReducedMotion
                    ? "opacity-100"
                    : isFrame4Animated
              ...
              >
                <div
                  className={`relative z-10 flex flex-col justify-between h-full ${
                    !prefersReducedMotion && isFrame4Animated ? "animate-s4-card-inner-5 opacity-65 fill-mode-forwards" : ""
                  }`}
                >
                  <span className="text-[11px] font-bold tracking-[0.08em] uppercase text-white/80 block mb-4">
                    TEAM
                ...
                <img
                  ...
                  alt=""
                  className="absolute bottom-2.5 right-3 w-[50px] h-[50px] sm:w-[58px] sm:h-[58px] pointer-events-none select-none z-0 object-contain"
                />
              </div>

              {/* STAGE 3: Card 6 - INTERNATIONAL (Malawi & Kenya) */}
              <div
                className={`relative overflow-hidden sm:col-span-2 lg:col-span-4 bg-[#2F7A44] text-white p-5 sm:p-6 rounded-[14px] flex flex-col justify-between min-h-[140px] ${
                  prefersReducedMotion
                    ? "opacity-100"
                    : isFrame4Animated
              ...
              >
                <div
                  className={`relative z-10 flex flex-col justify-between h-full ${
                    !prefersReducedMotion && isFrame4Animated ? "animate-s4-card-inner-6 opacity-65 fill-mode-forwards" : ""
                  }`}
                >
                  <span className="text-[11px] font-bold tracking-[0.08em] uppercase text-white/80 block mb-4">
                    INTERNATIONAL
                ...
                <img
                  ...
                  alt=""
                  className="absolute bottom-2.5 right-3 w-[46px] h-[46px] sm:w-[54px] sm:h-[54px] pointer-events-none select-none z-0 object-contain"
                />
              </div>
